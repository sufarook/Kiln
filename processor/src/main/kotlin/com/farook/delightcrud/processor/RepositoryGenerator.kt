...
object RepositoryGenerator {
    ...
    private val SCHEMA_MIGRATOR   = ClassName("com.farook.delightcrud.runtime", "SchemaMigrator")
    private val COLUMN_DEF        = ClassName("com.farook.delightcrud.runtime", "ColumnDef")
    ...
    private val OBSERVE_QUERY     = MemberName("com.farook.delightcrud.runtime", "observeQuery")
    private val COLUMN            = ClassName("com.farook.delightcrud.runtime", "Column")
    private val SQL_ARG           = ClassName("com.farook.delightcrud.runtime", "SqlArg")
    private val PREDICATE         = ClassName("com.farook.delightcrud.runtime", "Predicate")
    private val BIND_ARG          = MemberName("com.farook.delightcrud.runtime", "bindArg")
