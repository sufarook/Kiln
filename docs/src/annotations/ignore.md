...
- **Unsupported types** — when a property holds a type that Kiln cannot map to SQLite (e.g. `List<String>`). Serialize it yourself and store the serialized form in a supported column separately.
