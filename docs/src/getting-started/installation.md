...
!!! warning "Alpha release"
    Version `1.0.0-alpha04` is stable for Android production use. The public API is stable but minor breaking changes may occur before the `1.0.0` stable release. Watch the [GitHub releases](https://github.com/sufarook/Kiln/releases) page for updates.
