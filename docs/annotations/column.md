...
When you rename a property, DelightCRUD would normally treat it as "old column removed, new column added" — losing all existing data. Set `migrateFrom` to preserve the data across the rename.
