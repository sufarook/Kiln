...
This sample demonstrates DelightCRUD in a realistic multi-table scenario. It covers entity relationships, reactive observation, cross-table data loading, and DSL queries.
